...
export default function MapView({
  ...
  width,
  height,
  departureLatitude = 60.1699,
  departureLongitude = 24.9384, // Helsinki station coordinates as a fallback
}: MapViewProps) {
  ...
  const trainIcon = useMemo(() => {
    const trainIconString = ReactDOMServer.renderToString(<TrainRounded style={{ width: 30, height: 30, fill: "#192e02" }} />);
  ...
  return (
    <MapContainer center={position} zoom={10} style={{ width, height }}>
      <TileLayer
